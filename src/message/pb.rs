...
pub struct Header {
    ...
    hmac_hash_function: Option<Header_HmacHashFunction>,
    hmac_signer: ::protobuf::SingularField<String>,
    hmac_key_version: Option<u32>,
    hmac: ::protobuf::SingularField<Vec<u8>>,
...
impl<'a> Header {
    ...
    pub fn mut_message_length(&'a mut self) -> &'a mut u32 {
    ...
    pub fn get_message_length(&self) -> u32 {
        self.message_length.unwrap_or_else(|| 0)
    }
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_hmac_hash_function(&'a mut self) -> &'a mut Header_HmacHashFunction {
    ...
    pub fn get_hmac_hash_function(&self) -> Header_HmacHashFunction {
        self.hmac_hash_function.unwrap_or_else(|| Header_HmacHashFunction::new(0))
    }
    ...
    // Param is passed by value, moved
    pub fn set_hmac_signer(&mut self, v: String) {
        self.hmac_signer = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_hmac_signer(&'a mut self) -> &'a mut String {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_hmac_key_version(&'a mut self) -> &'a mut u32 {
    ...
    pub fn get_hmac_key_version(&self) -> u32 {
        self.hmac_key_version.unwrap_or_else(|| 0)
    }
    ...
    // Param is passed by value, moved
    pub fn set_hmac(&mut self, v: Vec<u8>) {
        self.hmac = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_hmac(&'a mut self) -> &'a mut Vec<u8> {
...
impl ::protobuf::Message for Header {
    ...
    fn descriptor_static(_: Option<Header>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                let mut fields: Vec<&'static ::protobuf::reflect::FieldAccessor<Header>> = Vec::new();
...
pub struct Field {
    ...
    value_type: Option<Field_ValueType>,
    representation: ::protobuf::SingularField<String>,
    value_string: ::protobuf::RepeatedField<String>,
    value_bytes: ::protobuf::RepeatedField<Vec<u8>>,
    value_integer: Vec<i64>,
    value_double: Vec<f64>,
    value_bool: Vec<bool>,
    unknown_fields: ::protobuf::UnknownFields,
}
...
impl<'a> Field {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_value_type(&'a mut self) -> &'a mut Field_ValueType {
    ...
    pub fn get_value_type(&self) -> Field_ValueType {
        self.value_type.unwrap_or_else(|| Field_ValueType::new(0))
    }
    ...
    // Param is passed by value, moved
    pub fn set_representation(&mut self, v: String) {
        self.representation = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_representation(&'a mut self) -> &'a mut String {
    ...
    // Param is passed by value, moved
    pub fn set_value_string(&mut self, v: ::protobuf::RepeatedField<String>) {
        self.value_string = v;
    }

    // Mutable pointer to the field.
    pub fn mut_value_string(&'a mut self) -> &'a mut ::protobuf::RepeatedField<String> {
        &mut self.value_string
    }

    pub fn get_value_string(&'a self) -> &'a [String] {
        self.value_string.as_slice()
    }

    pub fn add_value_string(&mut self, v: String) {
    ...
    // Param is passed by value, moved
    pub fn set_value_bytes(&mut self, v: ::protobuf::RepeatedField<Vec<u8>>) {
        self.value_bytes = v;
    }

    // Mutable pointer to the field.
    pub fn mut_value_bytes(&'a mut self) -> &'a mut ::protobuf::RepeatedField<Vec<u8>> {
        &mut self.value_bytes
    }

    pub fn get_value_bytes(&'a self) -> &'a [Vec<u8>] {
        self.value_bytes.as_slice()
    }

    pub fn add_value_bytes(&mut self, v: Vec<u8>) {
    ...
    // Param is passed by value, moved
    pub fn set_value_integer(&mut self, v: Vec<i64>) {
        self.value_integer = v;
    }

    // Mutable pointer to the field.
    pub fn mut_value_integer(&'a mut self) -> &'a mut Vec<i64> {
    ...
    // Param is passed by value, moved
    pub fn set_value_double(&mut self, v: Vec<f64>) {
        self.value_double = v;
    }

    // Mutable pointer to the field.
    pub fn mut_value_double(&'a mut self) -> &'a mut Vec<f64> {
    ...
    // Param is passed by value, moved
    pub fn set_value_bool(&mut self, v: Vec<bool>) {
        self.value_bool = v;
    }

    // Mutable pointer to the field.
    pub fn mut_value_bool(&'a mut self) -> &'a mut Vec<bool> {
        &mut self.value_bool
    }
...
impl ::protobuf::Message for Field {
    ...
    fn write_to_with_computed_sizes(&self, os: &mut ::protobuf::CodedOutputStream, sizes: &[u32], sizes_pos: &mut uint) {
        ...
        if !self.value_integer.is_empty() {
            ...
            os.write_raw_varint32(::protobuf::rt::vec_packed_varint_data_size(self.value_integer.as_slice()));
        ...
        if !self.value_double.is_empty() {
            ...
            os.write_raw_varint32((self.value_double.len() * 8) as u32);
        ...
        if !self.value_bool.is_empty() {
            ...
            os.write_raw_varint32((self.value_bool.len() * 1) as u32);
    ...
    #[allow(unused_unsafe,unused_mut)]
    fn descriptor_static(_: Option<Field>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy { lock: ::protobuf::lazy::ONCE_INIT, ptr: 0 as *const ::protobuf::reflect::MessageDescriptor };
        unsafe {
            descriptor.get(|| {
                let mut fields: Vec<&'static ::protobuf::reflect::FieldAccessor<Field>> = Vec::new();
...
impl ::protobuf::reflect::FieldAccessor<Field> for Field_value_string_acc_type {
    ...
    fn get_rep_str<'a>(&self, m: &'a Field) -> &'a [String] {
        m.get_value_string()
    }
}
...
impl ::protobuf::reflect::FieldAccessor<Field> for Field_value_bytes_acc_type {
    ...
    fn get_rep_bytes<'a>(&self, m: &'a Field) -> &'a [Vec<u8>] {
        m.get_value_bytes()
    }
}
...
pub struct HekaMessage {
    uuid: ::protobuf::SingularField<Vec<u8>>,
    timestamp: Option<i64>,
    field_type: ::protobuf::SingularField<String>,
    logger: ::protobuf::SingularField<String>,
    severity: Option<i32>,
    payload: ::protobuf::SingularField<String>,
    env_version: ::protobuf::SingularField<String>,
    pid: Option<i32>,
    hostname: ::protobuf::SingularField<String>,
...
impl<'a> HekaMessage {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_uuid(&'a mut self) -> &'a mut Vec<u8> {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_timestamp(&'a mut self) -> &'a mut i64 {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_field_type(&'a mut self) -> &'a mut String {
    ...
    // Param is passed by value, moved
    pub fn set_logger(&mut self, v: String) {
        self.logger = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_logger(&'a mut self) -> &'a mut String {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_severity(&'a mut self) -> &'a mut i32 {
    ...
    pub fn get_severity(&self) -> i32 {
        self.severity.unwrap_or_else(|| 0)
    }
    ...
    // Param is passed by value, moved
    pub fn set_payload(&mut self, v: String) {
        self.payload = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_payload(&'a mut self) -> &'a mut String {
    ...
    // Param is passed by value, moved
    pub fn set_env_version(&mut self, v: String) {
        self.env_version = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_env_version(&'a mut self) -> &'a mut String {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_pid(&'a mut self) -> &'a mut i32 {
        if self.pid.is_none() {
            self.pid = Some(0);
        };
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_hostname(&'a mut self) -> &'a mut String {
...
impl ::protobuf::Message for HekaMessage {
    ...
    #[allow(unused_unsafe,unused_mut)]
    fn descriptor_static(_: Option<HekaMessage>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy { lock: ::protobuf::lazy::ONCE_INIT, ptr: 0 as *const ::protobuf::reflect::MessageDescriptor };
        unsafe {
            descriptor.get(|| {
                let mut fields: Vec<&'static ::protobuf::reflect::FieldAccessor<HekaMessage>> = Vec::new();
